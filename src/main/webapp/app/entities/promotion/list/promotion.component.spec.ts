...
import { sampleWithRequiredData } from '../promotion.test-samples';
...
describe('Promotion Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.promotions()[0]).toEqual(expect.objectContaining({ id: 30739 }));
  });

  describe('trackId', () => {
    it('should forward to promotionService', () => {
      const entity = { id: 30739 };
      jest.spyOn(service, 'getPromotionIdentifier');
      const id = comp.trackId(entity);
      expect(service.getPromotionIdentifier).toHaveBeenCalledWith(entity);
